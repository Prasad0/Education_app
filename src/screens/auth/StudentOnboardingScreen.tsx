...
const StudentOnboardingScreen = ({ navigation }: StudentOnboardingFormProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const profileData = {
        ...
        education_level: formData.educationLevel || `${formData.currentStandard} ${formData.courseStream} Student`
      };
      ...
      if (createProfile.fulfilled.match(result)) {
        ...
        console.log('❌ Profile creation failed or rejected');
      }
    } catch (error) {
      Toast.show({
        type: 'error',
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerText}>
            ...
            <Text style={styles.headerSubtitle}>Help us find the perfect coaching for you</Text>
          </View>
        </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.pickerContainer}>
                <Picker
                  ...
                  onValueChange={(value) => handleInputChange('courseStream', value)}
                  style={styles.picker}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.pickerContainer}>
                <Picker
                  ...
                  onValueChange={(value) => handleInputChange('currentStandard', value)}
                  style={styles.picker}>
              ...
              <View style={styles.checkboxContainer}>
                {competitiveExams.map((exam) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.checkbox,
                      formData.targetExams.includes(exam.value) && styles.checkboxSelected
                    ]}
                    onPress={() => handleTargetExamChange(exam.value)}>
                    <Text style={[
                      styles.checkboxText,
                      formData.targetExams.includes(exam.value) && styles.checkboxTextSelected
                    ]}>
                      {exam.label}
                    </Text>
                  </TouchableOpacity>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(value) => handleInputChange('currentSchool', value)}
              />
            </View>
